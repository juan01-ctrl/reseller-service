      ...
      <div className="relative if-container">
        <div className="max-w-2xl">
          ...
          <motion.p
            ...
            className="if-after-h2-lead if-lead"
          >
        ...
        <div className="if-after-heading-block grid if-split-copy-visual lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-start">
          <motion.div
            ...
            transition={{ duration: 0.65, ease: easeOut }}
            className="if-panel overflow-hidden shadow-[0_50px_120px_-65px_rgba(0,0,0,0.95)]"
          >
          ...
          <motion.aside
            ...
            className="if-panel-muted p-6 lg:sticky lg:top-24"
          >
